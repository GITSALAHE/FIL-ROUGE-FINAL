...
const EditStory = () => {
    ...
    useEffect(() => {
        ...
        const getStoryInfo = async () => {
            setLoading(true)
            try {
                const { data } = await axios.get(process.env.REACT_APP_API_KEY +`/story/editStory/${slug}`, config)
                setStory(data.data)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const { data } = await axios.put(process.env.REACT_APP_API_KEY +`/story/${slug}/edit`, formdata, config)
                    ...
                    <div className="Inclusive-editStory-page ">
                        <form onSubmit={handleSubmit} className="editStory-form">
                            ...
                            <div class="currentlyImage">
                                ...
                                <img src={process.env.REACT_APP_API_KEY +`/storyImages/${previousImage}`} alt="storyImage" />
                            </div>
