...
const EditProfile = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const { data } = await axios.post(process.env.REACT_APP_API_KEY +"/user/editProfile", formdata, config)
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="profile-ımg-upld-wrapper">
                                ...
                                <div class="currentImage">
                                    ...
                                    <img src={process.env.REACT_APP_API_KEY +`/userPhotos/${previousPhoto}`} alt="userPhoto" />
                                </div>
